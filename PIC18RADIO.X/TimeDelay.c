...
void Delay10us( UINT32 tenMicroSecondCounter )
{
    INT32 InstructionClock = GetInstructionClock();
    
    volatile INT32 cyclesRequiredForEntireDelay;    
        
    #if defined(__18CXX) || defined (COMPILER_HITECH_PICC)
    
        if (InstructionClock <= 2500000) //for all FCY speeds under 2MHz (FOSC <= 10MHz)
        {
        ...
        else
        {
            ...
            cyclesRequiredForEntireDelay = (INT32)(InstructionClock/100000) * tenMicroSecondCounter;
            ...
            else
            {
                ...
                while (cyclesRequiredForEntireDelay > 0) //153 cycles used to this point.
                {
                    ...
                    //Subtract cycles burned while doing each delay stage, 42 in this case.
